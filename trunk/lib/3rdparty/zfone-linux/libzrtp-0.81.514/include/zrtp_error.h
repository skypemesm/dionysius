...
typedef enum zrtp_protocol_error_t
{
	...
	zrtp_error_no_secret		= 0x56, /** No shared secret available, DH mode required */
	...
	zrtp_error_wrong_meshash	= 0x201, /** Message hash doesn't match with pre-received one */
