...
struct zrtp_global_t
{
    ...
    struct BigNum			P_4096;
    struct BigNum			P_4096_1;
	...
	/** Head of digital signature schemes list */	
	//mlist_t               sigtype_head;
 ...
 */
typedef struct zrtp_proto_secret_tt
{
...
struct zrtp_session_t
{
	...
	/** Digital signature component used within current stream */
	// Digital Signature isn't available yet
	//zrtp_sig_scheme_t		*sigscheme;
