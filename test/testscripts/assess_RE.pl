...
print "RESULTS:\n----------------------------------\n\n";
print "RELATIVE ENTROPY:\t\t".$re."\n\n";
print "Symmetric RELATIVE ENTROPY:\t\t".$sre."\n\n";
print "Chi-Square Distance:\t\t".$chi."\n\n";
print "Bhattacharya Distance:\t\t".$bd."\n\n";
print "Information Radius:\t\t".$ir."\n\n";
